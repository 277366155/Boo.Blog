...
namespace Boo.Blog.CAP
{
    ...
    public class CapConsumerServiceSelector : ConsumerServiceSelector
    {
        ...
        /// </summary>
        public CapConsumerServiceSelector(IServiceProvider serviceProvider, IOptions<AbpDistributedEventBusOptions> distributedEventBusOpts)
                        : base(serviceProvider)
        {
            ServiceProvider = serviceProvider;
            AbpDistributedEventBusOptions = distributedEventBusOpts.Value;
        }
        ...
        protected override IEnumerable<ConsumerExecutorDescriptor> FindConsumersFromInterfaceTypes(IServiceProvider provider)
        {
            ...
            //return base.FindConsumersFromInterfaceTypes(provider);
        }
        ...
        private static ConsumerExecutorDescriptor InitDescriptor(TopicAttribute attr, MethodInfo methodInfo, TypeInfo implType, TypeInfo serviceTypeInfo, IList<ParameterDescriptor> parameters)
        {
