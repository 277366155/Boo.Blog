        ...
        */
        ...
        public static Sm2Cert readSm2File(byte[] pem, String pwd)
        {
            ...
            try
            {
                ...
                sm2Cert.certNum10 = x509.SerialNumber.IntValue.ToString();
                return sm2Cert;
            }
            catch (Exception e)
            {
        ...
        /// 解析SM2私钥
        /// </summary>
        /// <param name="sm2Text">SM2私钥文本</param>
        /// <param name="sm2Pwd">SM2私钥密码</param>
        /// <returns></returns>
        public static Sm2Cert ReadSm2Text(string sm2Text, string sm2Pwd)
        {
            byte[] bySm2Content = Convert.FromBase64String(sm2Text);
            Sm2Cert sm2Cert = readSm2File(bySm2Content, sm2Pwd);
            return sm2Cert;
        }
